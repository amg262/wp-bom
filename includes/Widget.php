...
class Widget extends \WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			'description' => esc_html__( 'WP Bom demo widget.', $this->plugin_slug ),
		);

		parent::__construct( 'wpr-widget', esc_html__( 'WP Bom', $this->plugin_slug ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		?><div class="wp-bom-widget" data-object-id="<?php echo $object_name ?>"></div><?php
