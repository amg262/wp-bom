...
abstract class Field implements FieldInterface {
    ...
    public function import($importData, $args = array()){
        ...
        if (!empty($this->importData['articleData']['ID']) && ! \pmai_is_acf_update_allowed($this->importData['container_name'] . $parsedData['name'], $this->parsingData['import']->options, $this->parsingData['import']->id) && empty($parsedData['xpath']['only_append_new'])) {
    ...
    public function isLocalFieldStorage(){
        return !is_numeric($this->getFieldOption('ID'));
    }
