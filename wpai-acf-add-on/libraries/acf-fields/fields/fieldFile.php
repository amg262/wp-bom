...
class FieldFile extends Field {
    ...
    public function getFieldValue() {
        ...
        if ("" != $values[$this->getPostIndex()] ) {
            ...
            $attachmentID = ACFService::import_file($this, $values[$this->getPostIndex()], $this->getPostID(), $parsingData['logger'], $parsingData['import']->options['is_fast_mode'], $search_in_gallery);
        }
        return $attachmentID;
    }
}